...
namespace ProjectBlock.Core
{
    ...
    public static class RarityTable
    {
            ...
            new Dictionary<string, Rarity>
        {
            ...
            { "simya", Rarity.Rare },
            { "kapali_ekonomi", Rarity.Common },
            { "ihale", Rarity.Common },
            { "kara_delik", Rarity.Rare },
            { "enfeksiyon", Rarity.Common },
            { "baba_ocagi", Rarity.Legendary },
            { "konfuzyon", Rarity.Legendary },
            ...
            { "devre", Rarity.Rare },
            { "sifaci", Rarity.Rare },
            { "yer_alti_kaynaklari", Rarity.Rare },
            { "metamorfoz", Rarity.Rare },
