...
namespace ProjectBlock.View
{
    ...
    public sealed class UiLayout
    {
        ...
        private void LoadDesktop()
        {
            ...
            BarsAsRow = false;
            JokerPanel = new Vector2(232f, 92f);
            JokerGap = 8f;
            PowerPanel = new Vector2(232f, 84f);
            PowerGap = 8f;
            CornerInset = 16f;
            BadgeSize = 92f;
            BadgeMargin = 16f;
            ...
            // MarketView.cs
            MarketStacked = false;
            MarketTopReserve = 1.5f;
            MarketBottomReserve = 2.15f;
        ...
        private void LoadPortrait()
        {
            ...
            BarsAsRow = true;
            // Square slots in a row: five jokers and three powers both fit across 1080 with room
            // to spare, which a 232-wide panel never could.
            JokerPanel = new Vector2(96f, 96f);
            JokerGap = 10f;
            PowerPanel = new Vector2(96f, 96f);
            PowerGap = 10f;
            CornerInset = 16f;
            BadgeSize = 76f;
            BadgeMargin = 16f;
            ...
            Vector2 panel, float gap, bool fromRight)
        {
            ...
            if (!Active.BarsAsRow)
            {
                ...
                rect.anchoredPosition = new Vector2(0f, -index * (panel.y + gap));
                return;
            }
