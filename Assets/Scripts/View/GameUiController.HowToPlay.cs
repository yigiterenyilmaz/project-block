        ...
        private static string[][] EnglishPages()
        {
            return new[]
            {
                ...
                new[]
                {
                    ...
                    "   TAP a joker to use it and HOLD it to sell it (same for powers), REROLL to",
                    "   restock the whole shelf for a price that rises each time you do it.",
        ...
        private static string[][] TurkishPages()
        {
            return new[]
            {
                ...
                new[]
                {
                    ...
                    "   jokeri kullanmak için DOKUN, satmak için BASILI TUT (güçler de aynı),",
                    "   bütün rafı yenilemek için REROLL - bedeli her kullanışta artar.",
